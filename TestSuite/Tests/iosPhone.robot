...
Resource         ../Resources/IOS_PO/ios_login.robot
Resource          ../Resources/IOS_PO/ios_first_login.robot
Resource          ../Resources/IOS_PO/ios_overview.robot
Resource          ../Resources/IOS_PO/ios_account_details.robot
Resource          ../Resources/IOS_PO/term_of_use.robot
Resource          ../Resources/IOS_PO/ios_credit_card.robot
Resource          ../Resources/IOS_PO/statements.robot
Resource          ../Resources/IOS_PO/bill_pay.robot
Resource          ../Resources/IOS_PO/quickbalance.robot
Resource         ../Resources/IOS_PO/ios_contact.robot
Resource         ../Resources/IOS_PO/ios_help.robot
Resource         ../Resources/IOS_PO/ios_locations.robot
Resource         ../Resources/IOS_PO/ios_online_banking.robot
Resource          ../Resources/IOS_PO/ios_forgot_password.robot
Resource          ../Resources/IOS_PO/ios_transfers.robot
#Suite Setup        Setup chromedriver
Test Setup         Open iphone simulator   #Open iphone 6 Plus       #common.Open iphone       #common.open ios simulator    #
...
trial
    main
#    ${t}  get new month name    05112017
#    log to console  ${t}
#   Login_into_ROB_2    Dddata7  test   sov12345
#   validate paperless is selected   *6390
   #close browser
...
Login With Incorrect Password
    [Tags]   Login
    ios_login.Incorrect Password  lcoben23   test   erertrtt
Login To Main Page
    [Tags]   Login
    Login Phone Into Mobile Retails   lcoben23  test  sov12345
...
Credit_Card_Filtering_Option_IN
     [Tags]  Account_Overview   Credit Filters
     Login Phone Into Mobile Retails  lcoben12   test   ben12345
...
Credit Cards Single Payment
    ...
    ios_credit_card.single payment  3839  0.1
Credit Cards Single Payment Future
    Login Phone Into Mobile Retails  ccdata5   test   sov12345
    ios_credit_card.single payment future  *3839  0.1  20170712
#Test test Case 14:
Contact_Us
     [Tags]  Contact_Us
...
Bill Pay Single Payment
    [Tags]  Single_payment
     Login without answer  robtest4  test  1234abcd
     bill_pay.Single Payment   Test Biller 2   0.05
...
Forgot Password Negative Incorrect UserID
    ...
    ios_forgot_password.Incorrect UserID  mmmmm  01011990

Forgot Password new pw is empty
    [Tags]  Forgot Password Negative    Forgot Password
    New Password Is Empty   lcoben12  01011990   test   2872   7101  ben12345  ${EMPTY}


Forgot Password - Negative - new pw is just characters (no digits)
    [Tags]  Forgot Password Negative     Forgot Password
    new pw is just characters no digits  lcoben6  01011990   test   2872   7101   lcotest  lcotest

Forgot Password - Negative - new pw is just numeric digits
    [Tags]  Forgot Password Negative    Forgot Password
    new pw is just numeric digits   lcoben15  01011990   test   2872   7101   1234567  1234567
